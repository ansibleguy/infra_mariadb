...
Molecule Logs: [Short](https://badges.ansibleguy.net/log/molecule_infra_mariadb_test_short.log), [Full](https://badges.ansibleguy.net/log/molecule_infra_mariadb_test.log)
